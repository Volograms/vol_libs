...
Module.initVologramFunctions = (containerObject) => {
	...
	insertObject["read_frame"] = Module.cwrap("read_frame", "boolean", [
		"number",
	]);
	insertObject["max_blob_sz"] = Module.cwrap("max_blob_sz", "number");
	insertObject["is_keyframe"] = Module.cwrap("is_keyframe", "boolean", [
		"number",
	]);
	insertObject[
		"find_previous_keyframe"
	] = Module.cwrap("find_previous_keyframe", "number", ["number"]);
	insertObject["frame_vertices"] = Module.cwrap("frame_vertices", "array");
	insertObject["frame_vertices_sz"] = Module.cwrap(
		"frame_vertices_sz",
		"number"
	);
	insertObject["frame_uvs_sz"] = Module.cwrap("frame_uvs_sz", "number");
	insertObject["frame_normals_sz"] = Module.cwrap(
		"frame_normals_sz",
		"number"
	);
	insertObject["frame_texture_data_ptr"] = Module.cwrap(
		"frame_texture_data_ptr",
		"number"
	);
	insertObject["frame_texture_sz"] = Module.cwrap(
		"frame_texture_sz",
		"number"
	);
	...
	insertObject["frame_uvs_copied"] = Module.cwrap(
		"frame_uvs_copied",
		"array"
	);
	insertObject["frame_normals_copied"] = Module.cwrap(
		"frame_normals_copied",
		"array"
	);
	insertObject["frame_indices_copied"] = Module.cwrap(
	...
	insertObject["basis_get_transcoded_ptr"] = Module.cwrap(
		"basis_get_transcoded_ptr",
		"number"
	);
	insertObject["basis_get_transcoded_sz"] = Module.cwrap(
		"basis_get_transcoded_sz",
		"number"
	);

	insertObject["run_basis_transcode"] = Module.cwrap(
		"run_basis_transcode",
		"boolean",
		["number"]
	);
	...
	insertObject["find_basis_fmt"] = (gl, hasAlpha = true) => {
		...
		if (
			...
			available_extensions.indexOf("WEBGL_compressed_texture_s3tc") >
				-1 ||
			available_extensions.indexOf("MOZ_WEBGL_compressed_texture_s3tc") >
				-1 ||
			available_extensions.indexOf(
			...
			glFmt = hasAlpha
				? dxt_ext.COMPRESSED_RGBA_S3TC_DXT5_EXT
				: dxt_ext.COMPRESSED_RGB_S3TC_DXT1_EXT;
			basisFmt = hasAlpha ? BASIS_FORMATS.BC3 : BASIS_FORMATS.BC1;
			format_text = hasAlpha
				? "COMPRESSED_RGBA_S3TC_DXT5_EXT (BC3)"
				: "COMPRESSED_RGB_S3TC_DXT1_EXT (BC1)";

			// ASTC (iOS)
		} else if (
			available_extensions.indexOf("WEBGL_compressed_texture_astc") > -1
		) {
			...
			available_extensions.indexOf("WEBGL_compressed_texture_etc") > -1
		) {
			...
			available_extensions.indexOf("WEBGL_compressed_texture_pvrtc") >
				-1 ||
			available_extensions.indexOf(
			...
			glFmt = hasAlpha
				? pvrtc_ext.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG
				: pvrtc_ext.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;
			basisFmt = hasAlpha
				? BASIS_FORMATS.PVRTC1_4_RGBA
				: BASIS_FORMATS.PVRTC1_4_RGB;
			format_text = hasAlpha
			...
			available_extensions.indexOf("EXT_texture_compression_bptc") > -1
		) {
...
var wasmBinaryFile;
if (Module['locateFile']) {
  wasmBinaryFile = 'vol_web.wasm';
  if (!isDataURI(wasmBinaryFile)) {
    wasmBinaryFile = locateFile(wasmBinaryFile);
  }
} else {
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  wasmBinaryFile = new URL('vol_web.wasm', import.meta.url).toString();
}
...
/** @type {function(...*):?} */
var _has_audio = Module["_has_audio"] = function() {
  return (_has_audio = Module["_has_audio"] = Module["asm"]["has_audio"]).apply(null, arguments);
};
...
/** @type {function(...*):?} */
var _texture_compression = Module["_texture_compression"] = function() {
  return (_texture_compression = Module["_texture_compression"] = Module["asm"]["texture_compression"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _texture_container_format = Module["_texture_container_format"] = function() {
  return (_texture_container_format = Module["_texture_container_format"] = Module["asm"]["texture_container_format"]).apply(null, arguments);
};
...
/** @type {function(...*):?} */
var _create_single_file_info = Module["_create_single_file_info"] = function() {
  return (_create_single_file_info = Module["_create_single_file_info"] = Module["asm"]["create_single_file_info"]).apply(null, arguments);
};
...
/** @type {function(...*):?} */
var _basis_init = Module["_basis_init"] = function() {
  return (_basis_init = Module["_basis_init"] = Module["asm"]["basis_init"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _basis_transcode = Module["_basis_transcode"] = function() {
  return (_basis_transcode = Module["_basis_transcode"] = Module["asm"]["basis_transcode"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _basis_get_transcoded_ptr = Module["_basis_get_transcoded_ptr"] = function() {
  return (_basis_get_transcoded_ptr = Module["_basis_get_transcoded_ptr"] = Module["asm"]["basis_get_transcoded_ptr"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _basis_get_transcoded_sz = Module["_basis_get_transcoded_sz"] = function() {
  return (_basis_get_transcoded_sz = Module["_basis_get_transcoded_sz"] = Module["asm"]["basis_get_transcoded_sz"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _run_basis_transcode = Module["_run_basis_transcode"] = function() {
  return (_run_basis_transcode = Module["_run_basis_transcode"] = Module["asm"]["run_basis_transcode"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _basis_free = Module["_basis_free"] = function() {
  return (_basis_free = Module["_basis_free"] = Module["asm"]["basis_free"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _audio_data_ptr = Module["_audio_data_ptr"] = function() {
  return (_audio_data_ptr = Module["_audio_data_ptr"] = Module["asm"]["audio_data_ptr"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _audio_data_sz = Module["_audio_data_sz"] = function() {
  return (_audio_data_sz = Module["_audio_data_sz"] = Module["asm"]["audio_data_sz"]).apply(null, arguments);
};
